import Euclid
import Sharygin15Problem29.Tarski
import Sharygin15Problem29.Midpoint
import Sharygin15Problem29.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 15, problem 29
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page15.Problem29.Affine.triangleCopies_aligned G hcol
