import Sharygin15Problem29.Sine
import Sharygin15Problem29.SimilarityTransport

/-!
# Independence of the right-triangle sine construction for problem 29
...
namespace Soultions.Sharygin.Page15.Problem29.SineCompatibility
...
open Soultions.Sharygin.Page15.Problem29.AngleTransport
open Soultions.Sharygin.Page15.Problem29.SimilarityTransport
    ...
    have hsupplementOrientation :
      ...
      calc
        ...
        _ = G.Orientation kOpp c s :=
          Soultions.Sharygin.Page15.Problem29.Pythagorean.option_reverse_involutive _
                    ...
                    calc
                      ...
                      _ = _ := by
                        simp only [
                          ...
                          Soultions.Sharygin.Page15.Problem29.Scalar.mul_left_comm]
            _ =
              L.scalar.mul
                (L.scalar.mul
                  (L.length s k)
...
theorem altitude_right_measure
    ...
    {a b c : G.Point}
    (altitude :
      Soultions.Sharygin.Page15.Problem29.Area.AltitudePair
        G a b c)
    (x : G.Point)
    (hx_on :
  ...
  rcases
      Soultions.Sharygin.Page15.Problem29.Pythagorean.sameRay_to_one_reflected_endpoint
  ...
  · have hrightMeasure :
        M.twice
          ...
          M.halfTurn :=
      Soultions.Sharygin.Page15.Problem29.Pythagorean.isosceles_midpoint_twice_angle
...
end Soultions.Sharygin.Page15.Problem29.SineCompatibility
