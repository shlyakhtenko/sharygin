...
import Sharygin15Problem29.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 13, problem 29
...
namespace Soultions.Sharygin.Page15.Problem29.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page15.Problem29.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page15.Problem29.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page15.Problem29.Median
