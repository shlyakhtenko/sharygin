...
import Sharygin15Problem29.Median
import Sharygin15Problem29.MidpointSquares

/-!
# SSS triangle transport for problem 29
...
namespace Soultions.Sharygin.Page15.Problem29.TriangleTransport
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page15.Problem29.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page15.Problem29.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page15.Problem29.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page15.Problem29.TriangleTransport
