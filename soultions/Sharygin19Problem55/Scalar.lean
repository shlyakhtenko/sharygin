...
/-! Problem-local scalar algebra for Sharygin, PDF page 19, problem 55. -/

namespace Soultions.Sharygin.Page19.Problem55.Scalar
...
end Soultions.Sharygin.Page19.Problem55.Scalar
