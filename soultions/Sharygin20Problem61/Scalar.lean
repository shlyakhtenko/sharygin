...
/-! Problem-local scalar algebra for Sharygin, PDF page 20, problem 61. -/

namespace Soultions.Sharygin.Page20.Problem61.Scalar
...
end Soultions.Sharygin.Page20.Problem61.Scalar
