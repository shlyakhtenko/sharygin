import Euclid
import Sharygin11Problem3.Tarski
import Sharygin11Problem3.Midpoint
import Sharygin11Problem3.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 11, problem 3
...
open Euclid Plane
open Soultions.Sharygin.Page11.Problem3.Tarski
open Soultions.Sharygin.Page11.Problem3.Midpoint
open Soultions.Sharygin.Page11.Problem3.Affine
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page11.Problem3.Affine.triangleCopies_aligned G hcol
