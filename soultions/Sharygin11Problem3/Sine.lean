import Sharygin11Problem3.Angle

/-!
# Right-triangle sine for Sharygin, page 11, problem 3
...
namespace Soultions.Sharygin.Page11.Problem3.Sine

open Euclid Plane
open Soultions.Sharygin.Page11.Problem3
...
theorem circumdiameter_sine_identity
    ...
    have hoppositeRight :
        M.twice
            (M.measure
              ⟨config.b, config.a, config.c, sense⟩) =
          M.halfTurn := by
      rw [inscribed_angle_twice G M sense
  ...
  · have htwiceAtD :
        M.twice
          ...
          M.measure
            ⟨config.b, circle.center, config.c, sense⟩ :=
      inscribed_angle_twice G M sense
...
end Soultions.Sharygin.Page11.Problem3.Sine
