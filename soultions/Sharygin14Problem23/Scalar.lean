import Sharygin14Problem23.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 14, problem 23

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page14.Problem23.Scalar
...
end Soultions.Sharygin.Page14.Problem23.Scalar
