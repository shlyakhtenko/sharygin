...
import Sharygin14Problem23.Midpoint
import Sharygin14Problem23.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 14, problem 23
...
namespace Soultions.Sharygin.Page14.Problem23
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page14.Problem23.Affine.triangleCopies_aligned G hcol
...
end Soultions.Sharygin.Page14.Problem23
