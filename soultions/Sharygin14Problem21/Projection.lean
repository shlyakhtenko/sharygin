import Sharygin14Problem21.Similarity
import Sharygin14Problem21.AngleOrder

/-!
# Problem-local perpendicular-bisector facts for Sharygin, page 14, problem 21
...
namespace Soultions.Sharygin.Page14.Problem21.Projection
...
open Soultions.Sharygin.Page14.Problem21.AngleOrder
...
theorem projection_pair_from_perpendicular_seed
    ...
    ∃ h t' u',
      ...
      G.Collinear t m t' ∧
      G.Collinear t m h ∧
      (G.Collinear w m o ∨ Parallel G h o m w) := by
...
end Soultions.Sharygin.Page14.Problem21.Projection
