import Sharygin14Problem21.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 14, problem 21

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page14.Problem21.Scalar
...
end Soultions.Sharygin.Page14.Problem21.Scalar
