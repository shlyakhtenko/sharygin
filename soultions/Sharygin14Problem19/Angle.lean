...
import Sharygin14Problem19.Midpoint
import Sharygin14Problem19.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 14, problem 19
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page14.Problem19.Affine.triangleCopies_aligned G hcol
