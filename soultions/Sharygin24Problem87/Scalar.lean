...
/-! Problem-local scalar algebra for Sharygin, PDF page 24, problem 87. -/

namespace Soultions.Sharygin.Page24.Problem87.Scalar
...
end Soultions.Sharygin.Page24.Problem87.Scalar
