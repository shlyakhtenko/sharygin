...
import Sharygin13Problem15.Tangent

/-!
# Circumscribed-polygon area for Sharygin, page 13, problem 15
...
namespace Soultions.Sharygin.Page13.Problem15.Polygon
...
open Soultions.Sharygin.Page13.Problem15.Tangent
...
theorem circumscribed_polygon_double_area
  ...
  | nil =>
      ...
      rw [OrderedScalar.Axioms.add_zero,
        Soultions.Sharygin.Page13.Problem15.Scalar.mul_zero]
  | cons side sides ih =>
      change
        L.scalar.add
            (L.scalar.add
...
end Soultions.Sharygin.Page13.Problem15.Polygon
