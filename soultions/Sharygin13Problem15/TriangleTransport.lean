...
import Sharygin13Problem15.Median
...
namespace Soultions.Sharygin.Page13.Problem15.TriangleTransport
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page13.Problem15.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page13.Problem15.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page13.Problem15.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page13.Problem15.TriangleTransport
