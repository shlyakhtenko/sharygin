import Sharygin13Problem15.Sine
import Sharygin13Problem15.SimilarityTransport

/-!
# Independence of the right-triangle sine construction for problem 15
...
namespace Soultions.Sharygin.Page13.Problem15.SineCompatibility

open Euclid Plane
open Soultions.Sharygin.Page13.Problem15.Tarski
open Soultions.Sharygin.Page13.Problem15.Affine
open Soultions.Sharygin.Page13.Problem15.Similarity
open Soultions.Sharygin.Page13.Problem15.AngleOrder
open Soultions.Sharygin.Page13.Problem15.AngleTransport
open Soultions.Sharygin.Page13.Problem15.SimilarityTransport
  ...
  calc
    ...
    _ =
      ...
      rw [Plane.Axioms.orientation_swap a o b,
        Soultions.Sharygin.Page13.Problem15.Pythagorean.option_reverse_involutive]
    ...
    have hsupplementOrientation :
      ...
      calc
        ...
        _ = G.Orientation kOpp c s :=
          Soultions.Sharygin.Page13.Problem15.Pythagorean.option_reverse_involutive _
...
theorem altitude_right_measure
    ...
    {a b c : G.Point}
    (altitude :
      Soultions.Sharygin.Page13.Problem15.Area.AltitudePair
        G a b c)
    (x : G.Point)
    (hx_on :
  ...
  rcases
      Soultions.Sharygin.Page13.Problem15.Pythagorean.sameRay_to_one_reflected_endpoint
  ...
  · have hrightMeasure :
        M.twice
          ...
          M.halfTurn :=
      Soultions.Sharygin.Page13.Problem15.Pythagorean.isosceles_midpoint_twice_angle
...
end Soultions.Sharygin.Page13.Problem15.SineCompatibility
