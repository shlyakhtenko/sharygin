...
import Sharygin13Problem15.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 13, problem 15
...
namespace Soultions.Sharygin.Page13.Problem15.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page13.Problem15.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page13.Problem15.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page13.Problem15.Median
