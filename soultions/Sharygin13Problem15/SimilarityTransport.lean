import Sharygin13Problem15.AngleTransport
import Sharygin13Problem15.SimilarityRatio
...
namespace Soultions.Sharygin.Page13.Problem15.SimilarityTransport
...
open Soultions.Sharygin.Page13.Problem15.TriangleTransport
open Soultions.Sharygin.Page13.Problem15.SimilarityRatio
...
theorem product_identity_of_two_angles_at_different_vertices
  ...
  let finish :
    ...
    fun {s} hnoncollinear hpdoS hcd_es hopposite => by
      ...
      have hproduct :=
        SimilarityRatio.product_identity_of_two_angles
...
end Soultions.Sharygin.Page13.Problem15.SimilarityTransport
