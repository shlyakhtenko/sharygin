...
/-!
# Area from the diagonals for Sharygin, page 13, problem 15
...
namespace Soultions.Sharygin.Page13.Problem15.DiagonalArea
    ...
    _ = L.scalar.mul
        ...
        (L.scalar.mul
          (L.scalar.add
            ...
            (L.length config.o config.d))
          config.diagonalSine.value) := by
      rw [Soultions.Sharygin.Page13.Problem15.Scalar.right_distrib]
    _ = L.scalar.mul
        (L.length config.a config.c)
        (L.scalar.mul
          (L.length config.b config.d)
...
end Soultions.Sharygin.Page13.Problem15.DiagonalArea
