...
/-! Problem-local scalar algebra for Sharygin, PDF page 26, problem 98. -/

namespace Soultions.Sharygin.Page26.Problem98.Scalar
...
end Soultions.Sharygin.Page26.Problem98.Scalar
