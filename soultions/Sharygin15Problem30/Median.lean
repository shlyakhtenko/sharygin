...
import Sharygin15Problem30.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 13, problem 30
...
namespace Soultions.Sharygin.Page15.Problem30.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page15.Problem30.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page15.Problem30.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page15.Problem30.Median
