import Sharygin15Problem30.Area
import Sharygin15Problem30.Median
import Sharygin15Problem30.MidpointSquares

/-!
# SSS triangle transport for problem 30
...
namespace Soultions.Sharygin.Page15.Problem30.TriangleTransport
...
open Soultions.Sharygin.Page15.Problem30.Projection
open Soultions.Sharygin.Page15.Problem30.Area
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page15.Problem30.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page15.Problem30.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page15.Problem30.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page15.Problem30.TriangleTransport
