import Euclid
import Sharygin15Problem30.Tarski
import Sharygin15Problem30.Midpoint
import Sharygin15Problem30.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 15, problem 30
...
namespace Soultions.Sharygin.Page15.Problem30
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page15.Problem30.Affine.triangleCopies_aligned G hcol
...
end Soultions.Sharygin.Page15.Problem30
