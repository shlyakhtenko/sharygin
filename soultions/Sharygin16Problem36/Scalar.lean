...
/-!
# Scalar identities for Sharygin, PDF page 16, problem 36

Only the ring identities used in this problem's direction calculation are
derived here.
-/

namespace Soultions.Sharygin.Page16.Problem36.Scalar
...
end Soultions.Sharygin.Page16.Problem36.Scalar
