...
/-!
# Scalar identities for Sharygin, PDF page 17, problem 44

Only the ring identities used in this problem's direction calculation are
derived here.
-/

namespace Soultions.Sharygin.Page17.Problem44.Scalar
...
end Soultions.Sharygin.Page17.Problem44.Scalar
