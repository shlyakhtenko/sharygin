import Euclid
import Sharygin13Problem13.Tarski
import Sharygin13Problem13.Midpoint
import Sharygin13Problem13.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 13, problem 13
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page13.Problem13.Affine.triangleCopies_aligned G hcol
