...
/-!
# Problem-local scalar algebra for Sharygin, page 13, problem 13

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page13.Problem13.Scalar
...
end Soultions.Sharygin.Page13.Problem13.Scalar
