import Sharygin16Problem31.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 16, problem 31

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page16.Problem31.Scalar
...
end Soultions.Sharygin.Page16.Problem31.Scalar
