...
/-!
# Problem-local scalar algebra for Sharygin, page 14, problem 22

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page14.Problem22.Scalar
...
end Soultions.Sharygin.Page14.Problem22.Scalar
