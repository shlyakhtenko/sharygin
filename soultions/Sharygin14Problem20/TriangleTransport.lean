import Sharygin14Problem20.Area
import Sharygin14Problem20.Median
import Sharygin14Problem20.MidpointSquares

/-!
# SSS triangle transport for problem 20
...
namespace Soultions.Sharygin.Page14.Problem20.TriangleTransport
...
open Soultions.Sharygin.Page14.Problem20.Area
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page14.Problem20.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page14.Problem20.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page14.Problem20.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page14.Problem20.TriangleTransport
