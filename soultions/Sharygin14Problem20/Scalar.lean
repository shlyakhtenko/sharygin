import Sharygin14Problem20.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 14, problem 20

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page14.Problem20.Scalar
...
/-- A product in the scalar field vanishes only when one factor vanishes. -/
...
/-- Squaring is injective on the nonnegative part of the scalar field. -/
...
end Soultions.Sharygin.Page14.Problem20.Scalar
