...
import Sharygin14Problem20.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 14, problem 20
...
namespace Soultions.Sharygin.Page14.Problem20.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page14.Problem20.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page14.Problem20.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page14.Problem20.Median
