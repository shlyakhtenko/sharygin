...
/-!
# Problem-local scalar algebra for Sharygin, page 15, problem 26

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page15.Problem26.Scalar
...
end Soultions.Sharygin.Page15.Problem26.Scalar
