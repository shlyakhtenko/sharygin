import Sharygin12Problem9.Bisector

/-!
# Problem-local angle-bisector ratio for Sharygin, page 12, problem 9
-/

namespace Soultions.Sharygin.Page12.Problem9.Ratio
...
end Soultions.Sharygin.Page12.Problem9.Ratio
