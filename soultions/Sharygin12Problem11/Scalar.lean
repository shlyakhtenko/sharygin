...
/-!
# Problem-local scalar algebra for Sharygin, page 12, problem 11

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page12.Problem11.Scalar
...
end Soultions.Sharygin.Page12.Problem11.Scalar
