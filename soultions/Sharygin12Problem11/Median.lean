...
import Sharygin12Problem11.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 12, problem 11
...
namespace Soultions.Sharygin.Page12.Problem11.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page12.Problem11.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page12.Problem11.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page12.Problem11.Median
