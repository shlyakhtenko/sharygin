import Euclid
import Sharygin12Problem11.Tarski
import Sharygin12Problem11.Midpoint
import Sharygin12Problem11.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 12, problem 11
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page12.Problem11.Affine.triangleCopies_aligned G hcol
