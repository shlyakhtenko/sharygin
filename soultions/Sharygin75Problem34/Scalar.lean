...
/-!
# Scalar identities for Sharygin, PDF page 75, problem 34

Only the ring identities used in this problem's determinant calculation are
derived here.
-/

namespace Soultions.Sharygin.Page75.Problem34.Scalar
...
end Soultions.Sharygin.Page75.Problem34.Scalar
