...
/-!
# Problem-local scalar algebra for Sharygin, page 74, problem 28

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page74.Problem28.Scalar
...
end Soultions.Sharygin.Page74.Problem28.Scalar
