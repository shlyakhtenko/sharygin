...
/-!
# Scalar identities for Sharygin, PDF page 18, problem 48

Only the ring identities used in this problem's direction calculation are
derived here.
-/

namespace Soultions.Sharygin.Page18.Problem48.Scalar
...
end Soultions.Sharygin.Page18.Problem48.Scalar
