import Sharygin14Problem18.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 14, problem 18

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page14.Problem18.Scalar
...
end Soultions.Sharygin.Page14.Problem18.Scalar
