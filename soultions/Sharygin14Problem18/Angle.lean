...
import Sharygin14Problem18.Midpoint
import Sharygin14Problem18.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 14, problem 18
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page14.Problem18.Affine.triangleCopies_aligned G hcol
