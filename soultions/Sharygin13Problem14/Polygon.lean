...
import Sharygin13Problem14.Tangent

/-!
# Circumscribed-polygon area for Sharygin, page 13, problem 14
...
namespace Soultions.Sharygin.Page13.Problem14.Polygon
...
open Soultions.Sharygin.Page13.Problem14.Tangent
...
theorem circumscribed_polygon_double_area
  ...
  | nil =>
      ...
      rw [OrderedScalar.Axioms.add_zero,
        Soultions.Sharygin.Page13.Problem14.Scalar.mul_zero]
  | cons side sides ih =>
      change
        L.scalar.add
            (L.scalar.add
...
end Soultions.Sharygin.Page13.Problem14.Polygon
