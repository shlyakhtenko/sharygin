import Euclid
import Sharygin13Problem14.Tarski
import Sharygin13Problem14.Midpoint
import Sharygin13Problem14.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 13, problem 14
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page13.Problem14.Affine.triangleCopies_aligned G hcol
