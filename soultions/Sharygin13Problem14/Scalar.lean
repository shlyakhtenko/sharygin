...
/-!
# Problem-local scalar algebra for Sharygin, page 13, problem 14

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page13.Problem14.Scalar
...
end Soultions.Sharygin.Page13.Problem14.Scalar
