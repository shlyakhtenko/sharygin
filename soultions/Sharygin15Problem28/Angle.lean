...
import Sharygin15Problem28.Midpoint
import Sharygin15Problem28.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 14, problem 28
...
namespace Soultions.Sharygin.Page15.Problem28
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page15.Problem28.Affine.triangleCopies_aligned G hcol
...
end Soultions.Sharygin.Page15.Problem28
