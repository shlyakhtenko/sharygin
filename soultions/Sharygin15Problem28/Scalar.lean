import Sharygin15Problem28.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 14, problem 28

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page15.Problem28.Scalar
...
end Soultions.Sharygin.Page15.Problem28.Scalar
