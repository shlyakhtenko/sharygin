import Sharygin16Problem34.Area
import Sharygin16Problem34.Median
...
namespace Soultions.Sharygin.Page16.Problem34.TriangleTransport
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page16.Problem34.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page16.Problem34.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page16.Problem34.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page16.Problem34.TriangleTransport
