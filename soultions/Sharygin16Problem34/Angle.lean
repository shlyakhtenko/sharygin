...
import Sharygin16Problem34.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 16, problem 34
...
namespace Soultions.Sharygin.Page16.Problem34
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page16.Problem34.Affine.triangleCopies_aligned G hcol
...
end Soultions.Sharygin.Page16.Problem34
