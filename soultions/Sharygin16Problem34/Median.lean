...
import Sharygin16Problem34.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 16, problem 34
...
namespace Soultions.Sharygin.Page16.Problem34.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page16.Problem34.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page16.Problem34.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page16.Problem34.Median
