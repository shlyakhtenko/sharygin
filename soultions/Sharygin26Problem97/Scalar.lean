...
/-! Problem-local scalar algebra for Sharygin, PDF page 26, problem 97. -/

namespace Soultions.Sharygin.Page26.Problem97.Scalar
...
end Soultions.Sharygin.Page26.Problem97.Scalar
