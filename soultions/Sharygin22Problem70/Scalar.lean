...
/-! Problem-local scalar algebra for Sharygin, PDF page 22, problem 70. -/

namespace Soultions.Sharygin.Page22.Problem70.Scalar
...
end Soultions.Sharygin.Page22.Problem70.Scalar
