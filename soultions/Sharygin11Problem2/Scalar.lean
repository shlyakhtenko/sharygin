...
/-!
# Problem-local scalar algebra for Sharygin, page 11, problem 2

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page11.Problem2.Scalar
...
end Soultions.Sharygin.Page11.Problem2.Scalar
