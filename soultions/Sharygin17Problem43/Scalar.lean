...
/-!
# Scalar identities for Sharygin, PDF page 17, problem 43

Only the ring identities used in this problem's direction calculation are
derived here.
-/

namespace Soultions.Sharygin.Page17.Problem43.Scalar
...
end Soultions.Sharygin.Page17.Problem43.Scalar
