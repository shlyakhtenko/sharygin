...
import Sharygin15Problem27.Midpoint
import Sharygin15Problem27.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 15, problem 27
...
namespace Soultions.Sharygin.Page15.Problem27
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page15.Problem27.Affine.triangleCopies_aligned G hcol
...
end Soultions.Sharygin.Page15.Problem27
