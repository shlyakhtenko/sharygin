...
/-! Problem-local scalar algebra for Sharygin, PDF page 21, problem 66. -/

namespace Soultions.Sharygin.Page21.Problem66.Scalar
...
theorem add_eq_of_sub_eq {x y z : S.Carrier}
    (h : S.sub x y = z) : x = S.add z y := by
  change S.add x (S.neg y) = z at h
...
end Soultions.Sharygin.Page21.Problem66.Scalar
