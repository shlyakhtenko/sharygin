...
/-! Problem-local scalar algebra for Sharygin, PDF page 20, problem 59. -/

namespace Soultions.Sharygin.Page20.Problem59.Scalar
...
end Soultions.Sharygin.Page20.Problem59.Scalar
