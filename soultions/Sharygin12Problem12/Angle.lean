import Euclid
import Sharygin12Problem12.Tarski
import Sharygin12Problem12.Midpoint
import Sharygin12Problem12.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 12, problem 12
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page12.Problem12.Affine.triangleCopies_aligned G hcol
