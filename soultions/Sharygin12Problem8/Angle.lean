...
import Sharygin12Problem8.Midpoint
import Sharygin12Problem8.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 12, problem 8
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page12.Problem8.Affine.triangleCopies_aligned G hcol
