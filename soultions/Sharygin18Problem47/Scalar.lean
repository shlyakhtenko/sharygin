...
/-!
# Scalar identities for Sharygin, PDF page 18, problem 47

Only the ring identities used in this problem's direction calculation are
derived here.
-/

namespace Soultions.Sharygin.Page18.Problem47.Scalar
...
end Soultions.Sharygin.Page18.Problem47.Scalar
