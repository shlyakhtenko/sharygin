import Sharygin73Problem27.Midpoint

/-!
# Problem-local affine layer for Sharygin, page 73, problem 27
...
namespace Soultions.Sharygin.Page73.Problem27.Affine
...
/--
Two lines through the same point that are both disjoint from a fixed line coincide.

This is the precise Playfair consequence needed below.  The proof is the same
separation-and-crossbar argument used inside `midpoint_grid_align`, isolated here so the median
construction can use the consequence without importing a general affine theory.
-/
...
end Soultions.Sharygin.Page73.Problem27.Affine
