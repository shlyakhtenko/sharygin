import Sharygin73Problem27.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 73, problem 27

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page73.Problem27.Scalar
...
end Soultions.Sharygin.Page73.Problem27.Scalar
