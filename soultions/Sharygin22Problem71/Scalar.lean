...
/-! Problem-local scalar algebra for Sharygin, PDF page 22, problem 71. -/

namespace Soultions.Sharygin.Page22.Problem71.Scalar
...
end Soultions.Sharygin.Page22.Problem71.Scalar
