...
/-!
# Scalar algebra for Sharygin, PDF page 75, problem 33

Only identities appearing in the coordinate proof are developed here.
-/

namespace Soultions.Sharygin.Page75.Problem33.Scalar
...
theorem mul_left_cancel {x y z : S.Carrier}
    (hx : x ≠ S.zero)
...
end Soultions.Sharygin.Page75.Problem33.Scalar
