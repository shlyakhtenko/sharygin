...
/-!
# Problem-local scalar algebra for Sharygin, page 15, problem 24

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page15.Problem24.Scalar
...
end Soultions.Sharygin.Page15.Problem24.Scalar
