...
/-!
# Problem-local directed-angle layer for Sharygin, page 15, problem 24
...
namespace Soultions.Sharygin.Page15.Problem24
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page15.Problem24.Affine.triangleCopies_aligned G hcol
...
end Soultions.Sharygin.Page15.Problem24
