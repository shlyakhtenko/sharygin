...
/-!
# Problem-local median calculation for Sharygin, page 15, problem 24
...
namespace Soultions.Sharygin.Page15.Problem24.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page15.Problem24.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page15.Problem24.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page15.Problem24.Median
