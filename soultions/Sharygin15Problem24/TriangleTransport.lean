...
namespace Soultions.Sharygin.Page15.Problem24.TriangleTransport
...
open Soultions.Sharygin.Page15.Problem24.TransportArea
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page15.Problem24.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page15.Problem24.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page15.Problem24.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page15.Problem24.TriangleTransport
