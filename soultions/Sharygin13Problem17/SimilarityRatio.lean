...
This is kept in problem 17 because the project is deliberately retaining duplicated proofs
until recurring abstractions emerge from completed examples.
-/

namespace Soultions.Sharygin.Page13.Problem17.SimilarityRatio
...
end Soultions.Sharygin.Page13.Problem17.SimilarityRatio
