import Sharygin13Problem17.Area
import Sharygin13Problem17.Median
import Sharygin13Problem17.MidpointSquares

/-!
# SSS triangle transport for problem 17
...
namespace Soultions.Sharygin.Page13.Problem17.TriangleTransport
...
open Soultions.Sharygin.Page13.Problem17.Area
...
theorem squared_median_formula_all
  ...
  · have hline : G.Collinear b m a := by
    ...
    have hsum :=
      Soultions.Sharygin.Page13.Problem17.MidpointSquares.reflected_endpoint_square_sum
  ...
  · let config :
        Soultions.Sharygin.Page13.Problem17.Median.Configuration G := {
      a := a
      b := b
      c := c
      midpoint := m
    ...
    exact
      Soultions.Sharygin.Page13.Problem17.Median.squared_median_formula
        G M L config
...
end Soultions.Sharygin.Page13.Problem17.TriangleTransport
