...
import Sharygin13Problem17.Parallelogram

/-!
# Problem-local median calculation for Sharygin, page 13, problem 17
...
namespace Soultions.Sharygin.Page13.Problem17.Median
...
theorem reflected_vertex_parallelogram_identity
  ...
  let parallelogramConfig :
      Soultions.Sharygin.Page13.Problem17.Parallelogram.Configuration G := {
    a := config.a
    b := config.b
    c := aOpposite
    d := config.c
  ...
  have hparallelogram :=
    Soultions.Sharygin.Page13.Problem17.Parallelogram.diagonal_square_sum
...
end Soultions.Sharygin.Page13.Problem17.Median
