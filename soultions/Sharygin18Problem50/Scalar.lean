...
/-! Problem-local additive algebra for Sharygin, PDF page 18, problem 50. -/

namespace Soultions.Sharygin.Page18.Problem50.Scalar
...
end Soultions.Sharygin.Page18.Problem50.Scalar
