...
/-! Problem-local scalar cancellation for Sharygin, PDF page 21, problem 67. -/

namespace Soultions.Sharygin.Page21.Problem67.Scalar
...
end Soultions.Sharygin.Page21.Problem67.Scalar
