...
/-! Problem-local scalar identities for Sharygin, PDF page 19, problem 53. -/

namespace Soultions.Sharygin.Page19.Problem53.Scalar
...
end Soultions.Sharygin.Page19.Problem53.Scalar
