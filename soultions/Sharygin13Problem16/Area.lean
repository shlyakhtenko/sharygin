...
import Sharygin13Problem16.Pythagorean

/-!
# Problem-local area consequences for Sharygin, page 13, problem 16
...
namespace Soultions.Sharygin.Page13.Problem16.Area
...
theorem altitude_leg_double_area
  ...
  rcases
      Soultions.Sharygin.Page13.Problem16.Pythagorean.sameRay_to_one_reflected_endpoint G
  ...
  calc
    ...
    _ = L.scalar.mul
          (L.scalar.add
            ...
            (L.length altitude.foot b))
          (L.length altitude.foot c) :=
      (Soultions.Sharygin.Page13.Problem16.Scalar.right_distrib
        L.scalar _ _ _).symm
    _ = L.scalar.mul
          (L.length a b)
          (L.length altitude.foot c) := by
...
theorem triangle_double_area_of_foot_a_b
  ...
  rw [AreaMeasurement.Axioms.cyclic M c altitude.foot b,
    ...
    at hcut
  apply
    Soultions.Sharygin.Page13.Problem16.Scalar.add_left_cancel
      L.scalar
      (x :=
        L.scalar.add
          (A.triangleArea altitude.foot a c)
...
theorem area_scale_on_line
  ...
  have harea' :=
    triangle_double_area_base_height_all
      G M L A altitude' hnoncollinear' sense
  apply
    Soultions.Sharygin.Page13.Problem16.Scalar.add_self_injective
      L.scalar
  calc
    L.scalar.add
          (L.scalar.mul
    ...
    _ = L.scalar.mul
      ...
      simp only [OrderedScalar.Axioms.mul_assoc,
        ...
        Soultions.Sharygin.Page13.Problem16.Scalar.mul_left_comm
          L.scalar]
    _ = L.scalar.mul
          (L.scalar.add
            (A.triangleArea a b' c)
...
end Soultions.Sharygin.Page13.Problem16.Area
