...
import Sharygin13Problem16.Midpoint
import Sharygin13Problem16.Affine

/-!
# Problem-local directed-angle layer for Sharygin, page 13, problem 16
...
private theorem triangle_turn (M : AngleMeasurement G) [M.Axioms]
  ...
  obtain ⟨copies, hyax⟩ :=
    Soultions.Sharygin.Page13.Problem16.Affine.triangleCopies_aligned G hcol
