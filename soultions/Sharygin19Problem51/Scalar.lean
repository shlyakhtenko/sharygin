import Sharygin19Problem51.Tarski

/-!
# Problem-local scalar algebra for Sharygin, page 19, problem 51

Only identities that occur in the power calculation are derived here from
`OrderedScalar.Axioms`.
-/

namespace Soultions.Sharygin.Page19.Problem51.Scalar
...
end Soultions.Sharygin.Page19.Problem51.Scalar
